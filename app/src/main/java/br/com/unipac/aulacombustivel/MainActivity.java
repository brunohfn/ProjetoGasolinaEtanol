    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(i > 0.7){
                    Toast.makeText(MainActivity.this, "Compensa por Gasolina", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(MainActivity.this, "Compensa por Etanol", Toast.LENGTH_LONG).show();
                }
            }
        });
